...
fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": Activer pour trier les colonnes en ascendant"},oPaginate:{sFirst:"Premier",sLast:"Dernier",sNext:"Suivant",sPrevious:"Précédent"},
sEmptyTable:"La table ne contient pas de données",sInfo:"Affichage de _START_ à _END_ de _TOTAL_ ligne(s)",sInfoEmpty:"Affichage 0 à 0 de 0 ligne",sInfoFiltered:"(Filtrage du total des _MAX_  lignes)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ lignes",sLoadingRecords:"Chargement...",sProcessing:"Traitement...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Votre recherche ne donne aucun résultat"},oSearch:h.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",
